		...
		<div class="reply__body">
			...
			<form action="#">
				<div class="reply__wrapper">
					<div>
						<label for="name">Ваше имʼя <span>*</span></label>
					...
					<div class="footer__contacts">
						<div class="footer__contacts-item">
							...
							<div class="footer__contacts-tel">
								<a href="tel:+797867834347">+380867834347</a>
								<a href="tel:+797867834358">+380867834358</a>
							</div>
						</div>
						<div class="footer__contacts-item">
							<img src="<?php echo bloginfo('template_url');?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
							<address>вул. Тараса Шевченко, 1<br>
								Київ, Україна, 21021</address>
						</div>
					</div>
				</div>
			</div>
