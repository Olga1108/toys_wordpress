...
?>
			...
			<div class="row">
				<div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
					<div class="about__img">
						<img src="<?php the_field('about_img'); ?>" alt="про компанію">
					</div>
				</div>
	...
	<div class="toys" id="toys">
		<div class="container">
			<h2 class="subtitle">Мʼякі іграшки</h2>
			...
			?>
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_1.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Плюшевий ведмідь</div>
						<div class="toys__item-descr">
							Класика. Повинен бути в кожної дитини!
						</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
				...
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_2.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Совеня</div>
						<div class="toys__item-descr">
							Хочете, щоб ваша дитина була під захистом навіть вночі? Купить їй совеня!
						</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
				...
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_3.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Кроліки</div>
						<div class="toys__item-descr">
							Кроліки бувають різні... Але всі вони надзвичайно милі!</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
				...
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_4.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Гнучкі</div>
						<div class="toys__item-descr">
							Доречі в нас великий вибір іграшок, позу яких обирає сама дитина. (Долговічні. Ноги-руки не відламуються)
						</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_5.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Персонажі</div>
						<div class="toys__item-descr">
							Ваша дитина в захваті від персонажа мультфільма? Ми слідкуємо за всіма трендами и раді запропонувати як найсучасніших, так и персонажів "з нашого дитинства"
						</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_6.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Незвичайні</div>
						<div class="toys__item-descr">
							Хочете приємно здивувати вашу дитину? Подаруйте играшки нашого власного виготовлення! Вони унікальні и ваша дитина буде власником ексклюзива!
						</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
			...
			<div class="toys__wrapper">
				...
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_7.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Повітряний змій</div>
						<div class="toys__item-descr">
							Хто в дитинстві не хотів навчитись літати? А змій допоможе поймати вітер й унести всі клопоти далеко-далеко...
						</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
				...
				<div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url');?>/assets/img/toy_8.jpg)">
					<div class="toys__item-info">
						<div class="toys__item-title">Музичні</div>
						<div class="toys__item-descr">
							Спробуйте зацікавити дитину музикою! Може в нії притаївся майбутній Джаред Лето!
						</div>
						<div class="minibutton toys__trigger">Детальніше</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="toys__alert">
						<span>Не знайшли те, що шукали?</span> Звʼяжіться з нами - и ми з радістю створимо будь-яку іграшку за вашим бажанням. Ви можете обрати все: розмір, матеріал, форми...!
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="contacts__descr underlined">
						Ми знаходимось в м.Київ, метро "Золоті Ворота", в діловому центрі "Парк перемоги", другий поверх
						<br> <br>
						за адресою вул. Тараса Шевченко, 1
					</div>
				</div>
				<div class="col-lg-6">
							...
							<ul class="glide__slides">
								<li class="glide__slide">
									...
									<div class="feedslider__text">
										Дуже вдячний за ввічливість та терплячість. Звернулась до вас тільки з ідеєю для подарунка, а ви розвинули її до повноцінного проекту! Так що мій син тепер кожного дня грає з залізною дорогою, побудованою за його проектом)
										<br><br>
										Окреме дякую менеджеру Маргариті за терплячість та стійкість!
									</div>
								</li>
								<li class="glide__slide">
									<div class="feedslider__title">
										Черкесенко Олексій Дмитрович
									</div>
									<div class="feedslider__text">
										Замовляв тут велику партію іграшок для дитячого садка. Новий рік пройшов на ура! Тепер всі діточки щасливі й не розлучаються зі своїми подарунками, а найхітріші запитують коли наступні свята)
									</div>
								</li>
								<li class="glide__slide">
									<div class="feedslider__title">
									...
									<div class="feedslider__text">
										Вирішила до дня народження своєї прінцеси замовити іграшки тут. Жодного разу не пожалкувала! Ведмежатко саме таке, як я хотіла, прямо як у мене в дитинстві: мʼякий, приємний на дотик и дуууже милий. Одразу видно, що ручна робота.
									</div>
								</li>
							</ul>
						</div>
